...
class CompatibilityAPITest(unittest.TestCase):
    """Compatibility synchronous test with Zabbix API version 6.0"""
...
class CompatibilitySenderTest(unittest.TestCase):
    """Compatibility synchronous test with Zabbix sender version 6.0"""
...
class CompatibilityGetTest(unittest.TestCase):
    """Compatibility synchronous test with Zabbix get version 6.0"""
...
class CompatibilityAsyncAPITest(unittest.IsolatedAsyncioTestCase):
    """Compatibility asynchronous test with Zabbix API version 6.0"""
...
class CompatibilityAsyncSenderTest(unittest.IsolatedAsyncioTestCase):
    """Compatibility asynchronous test with Zabbix sender version 6.0"""
...
class CompatibilityAsyncGetTest(unittest.IsolatedAsyncioTestCase):
    """Compatibility asynchronous test with Zabbix get version 6.0"""
